namespace DubstepFight.CharacterInfoFolder
{
    partial class BlackKnightInfoForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label8.Text = "За каждые 2% потерянного здоровья тёмный рыцарь получает\r\nдопольнительный 1% к ур" +
    "ону. При здоровье ниже 40%\r\nбазовые атаки имеют шанс 30%  восстановаить 15 здоро" +
    "вья.";
            // 
            // label7
            // 
